  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/chats': (contex) => Chats(myUserId: '29'),
        ...
        '/profile': (context) => MyProfilePage(currentUserId: '29', currentUserEmail: 'bsc-inf-04-22@unima.ac.mw'),
        
        '/contacts': (context) => ContactsScreen(myUserId: '8'),
      },
