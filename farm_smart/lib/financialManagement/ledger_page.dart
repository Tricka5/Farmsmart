                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: Text(ledger.itemname, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 75, 75, 75))),
                        subtitle: Text('${ledger.transactor} | ${ledger.date}', style: const TextStyle(color: Color.fromARGB(255, 58, 58, 58))),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('Type: ${entry.type ?? ''}', style: const TextStyle(color: Color.fromARGB(255, 78, 78, 78))),
                                      ],
                                    ),
                                  ),
                                  IconButton(
                      ...
                      TextButton(
                        ...
                        child: const Text('Add Entry',style: TextStyle(color: Colors.green),),
                      ),
                      TextButton(
                        onPressed: () => _deleteLedger(ledger.id),
                        child: const Text('Delete Ledger',style: TextStyle(color: Colors.green),),
                      ),
                    ],
                  ),
                );
