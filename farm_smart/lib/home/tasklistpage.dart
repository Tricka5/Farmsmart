  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: TaskReminderScreen(
        currentUserId: "12345", // Example user ID
        currentUserEmail: "user@example.com", // Example user email
      ),
...
class TaskReminderScreen extends StatefulWidget {
  ...
  TaskReminderScreen({required this.currentUserId, required this.currentUserEmail});
                    ...
                    onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => FarmSmartScreen(
                          currentUserId: widget.currentUserId, // Pass user ID here
                          currentUserEmail: widget.currentUserEmail, // Pass email here
                        ),
                      ),
                    ),
                    child: Icon(
