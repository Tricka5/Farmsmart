...
import 'package:farmsmart/users/profile_page.dart';


class FarmSmartScreen extends StatefulWidget {
  final String currentUserId;  // Add the currentUserId field
  final String currentUserEmail;  // Add the currentUserEmail field

  const FarmSmartScreen({
    Key? key,
    required this.currentUserId,  // Add constructor parameter
    required this.currentUserEmail,  // Add constructor parameter
  }) : super(key: key);
                ...
                Row(
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        // Pass currentUserId and currentUserEmail to the profile page
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MyProfilePage(
                              currentUserId: widget.currentUserId,  // Use widget values
                              currentUserEmail: widget.currentUserEmail,  // Use widget values
                            ),
                          ),
                        );
                      },
        ...
        onTap: (index) {
          switch (index) {
            case 0:
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Chats(myUserId: widget.currentUserId)), // Replace with your page
              );
              break;
            case 1:
              Navigator.push(
