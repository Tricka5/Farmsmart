...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  Future<void> _getProfileData() async {
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.123:3000/users/${widget.currentUserId}'),
      );
  ...
  Future<void> _updateProfilePicture() async {
    ...
    final uri = Uri.parse('http://localhost/cloudinary/upload');
          ...
          onPressed: _isSubmitting
              ...
              : () {
                  if (_formKey.currentState!.validate()) {
                    if (fieldName == 'firstname') {
                      _updateProfileField('http://192.168.1.123:3000/users/updatefirstname', fieldName, firstName);
                    } else if (fieldName == 'lastname') {
                      _updateProfileField('http://192.168.1.123:3000/users/updatelastname', fieldName, lastName);
                    }
                  }
                },
        ),
